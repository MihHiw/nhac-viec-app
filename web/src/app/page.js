      ...
      <main className={styles.main}>
        <div className={styles.heroText}>
          ...
          <div className={styles.btnGroup}>
            <a href="https://github.com/MihHiw/nhac-viec-app/raw/main/android/app/build/outputs/apk/debug/app-debug.apk" download="NhacViec.apk" className={styles.btnDownload}>
          ...
          <p className={styles.note}>* File cài đặt APK an toàn, dung lượng ~ 32MB (Bao gồm AI Giọng nói)</p>
        </div>
